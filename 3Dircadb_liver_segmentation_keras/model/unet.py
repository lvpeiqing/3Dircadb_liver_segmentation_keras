...
# # part1部分储存的数据文件
# outputPath = 'E:/keras/liver_tumor_segmentation_keras/data/h5/train_liver.h5'  # 训练文件
# val_outputPath = 'E:/keras/liver_tumor_segmentation_keras/data/h5/val_liver.h5'
